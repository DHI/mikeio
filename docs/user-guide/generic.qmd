...
* When the full file header must be preserved: the generic functions copy it verbatim from the input file, including data type, delete values and [custom blocks](dfs2.qmd#custom-blocks) of any file type

...
* [`interp_like`](`mikeio.Dataset.interp_like`) - Spatio (temporal) interpolation (see [Dfsu 2D interpolation](../examples/dfsu/spatial_interpolation.qmd))
* [`interp_time()`](`mikeio.Dataset.interp_time`) - Temporal interpolation (see [Time interpolation](../examples/Time-interpolation.qmd))
